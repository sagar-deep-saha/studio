(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_components_92b0915a._.js", {
...
function LoginForm() {
    ...
    const onSubmit = (data)=>{
        // Simulate API call
        try {
            login(data.email); // Mock login, only uses email
            toast({
...
_s(LoginForm, "Wv1ByDq+Abj+EPMg2EgMuABs0p4=", false, function() {
    return [
...
//# sourceMappingURL=src_components_92b0915a._.js.map